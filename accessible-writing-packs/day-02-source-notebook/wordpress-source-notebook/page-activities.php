...
<main id="main" class="writing-flow">
  <article>
    ...
    <h1><?php the_title(); ?></h1>
    <?php if ( get_theme_mod( 'source_notebook_enable_activities', false ) ) : ?>
    ...
    <?php else : ?>
      <p>Activities are installed but off. Enable them in Appearance then Customize then Source Notebook options.</p>
    <?php endif; ?>
  </article>
</main>
<?php get_footer(); ?>
