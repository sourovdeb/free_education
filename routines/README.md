...
### 3️⃣ **03_psych_claims_audit_routine**

**What it does:** Researches and audits claims about human psychology, neuroscience, marketing influence, and mental health treatment — checking primary sources, methodology, funding/conflicts of interest, and opposing research — then publishes a short sourced verdict.

**Contains:**
- One markdown entry per audited claim
- Each entry: a 200–300 word micro-blog summary plus full audit notes (methodology, funding, bias check, comparison)

**Frequency:** As needed  
**Output format:** Markdown (.md)  
**Status:** ✅ Active

📖 [Go to routine →](03_psych_claims_audit_routine/)
