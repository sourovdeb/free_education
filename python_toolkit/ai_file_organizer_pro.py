...
from PyQt6.QtWidgets import (
    ...
    QComboBox, QProgressBar, QSizePolicy, QFrame
)
...
class AIFileOrganizerUI(QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("AI File Organizer Pro  ·  v2.0")
        self.resize(680, 860)
    ...
    def _build_ui(self):
        ...
        rl.addWidget(self.instruction_box)
        ...
        root.addWidget(self.console, 1)   # stretch=1 → console eats all extra vertical space
